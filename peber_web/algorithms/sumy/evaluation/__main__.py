...
def main(args=None):
    ...
    print ("Summarizer: %s" % summarizer)
    print ("document: %s" % document)
    print ("items_count: %s" % items_count)
    print (r"reference_summary: %r" % reference_summary)

    # Ringkasan yg akan dibandingkan dengan ringkasan sebelumnya.
    evaluated_sentences = summarizer(document, items_count)

    # Ringkasan acuan (reference_summary)
    ...
    print ("Tipe evaluated_sentences: %s" % type(evaluated_sentences))
    print ("Tipe reference_sentences: %s" % type(reference_sentences))
...
def handle_arguments(args):
    ...
    if args["--url"] is not None:
        ...
        print ("input stream: %s" % input_stream)
